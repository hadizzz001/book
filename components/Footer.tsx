                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myBB">
                                    All rights reserved © {(new Date().getFullYear())} Twisted BookEnds
                                </span>
                            </div>
                        </div>
                    </div>

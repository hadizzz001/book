      ...
      <div className="pageHeaderContainer">
        ...
        <div className="pageHeaderMenuPreHeader" id="PageMenuPreHeader">
          ...
          <style
            ...
            dangerouslySetInnerHTML={{
              __html:
                '.mobileNewsletter{position:absolute;top:25px;left:62px}.menuicon{position:relative}.menuicon .indicator{position:absolute;top:-14px;right:-9px;border-radius:50%;background-color:#ef0f87;color:#999;font-size:10px;height:12px;line-height:13px;text-indent:1px;white-space:nowrap;min-width:12px;text-align:center;font-family:"Lucida Console", Monaco, monospace;border:2px solid #999;box-sizing:content-box}@media (min-width: 768px){.mobileNewsletter{display:none}.menuicon .indicator{top:-17px}}\n'
            }}
          />

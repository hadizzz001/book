  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="EmptyCartBlurb myGray1">Thank you for your purchase!</h1>
        <p className='mb-10 myGray1'>Your order has been successfully processed.</p>
        <a
          href="/"
